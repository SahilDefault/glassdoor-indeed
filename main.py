...
if args.credentials:
    with open(args.credentials) as f:
        d = json.loads(f.read())
        args.username = d['sk0196146@gmail.com']
        args.password = d['P@ssw0rd9']
else:
    try:
...
#     browser = wd.Chrome(executable_path=os.environ.get("CHROMEDRIVER_PATH"), chrome_options=chrome_options)
#     return browser
